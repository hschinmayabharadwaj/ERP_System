...
// Simple theme context to replace next-themes
...
export function ServerManagementTable({
  ...
  const getOSIcon = (osType) => {
    switch (osType) {
      case "windows":
        return (
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center p-1.5 border border-slate-700/50">
      ...
      case "ubuntu":
        return (
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center p-1.5 border border-slate-700/50">
      ...
      case "linux":
        return (
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center border border-slate-700/50">
  ...
  const getCPUBars = (percentage, status) => {
    const filledBars = Math.round((percentage / 100) * 10);
    
    const getBarColor = (index) => {
      if (index >= filledBars) {
        return "bg-slate-800/40 border border-slate-700/30";
      }
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto p-6 ${className}`}>
      <div className="relative border border-slate-700/30 rounded-2xl p-6 bg-slate-900/50">
        {/* Header */}
        ...
        >
          ...
          {servers.map((server) => (
            ...
            >
              <motion.div
                className="relative bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 overflow-hidden"
                whileHover={{
                  y: -1,
              ...
              >
                ...
                <div className="relative grid grid-cols-12 gap-4 items-center">
                  ...
                  {/* Service Location */}
                  <div className="col-span-2 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full overflow-hidden border border-slate-700/30 flex items-center justify-center">
        ...
        <AnimatePresence>
          {selectedServer && (
            <motion.div
              ...
              className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm flex flex-col rounded-2xl z-10 overflow-hidden"
            >
              {/* Header with Actions */}
              <div className="relative bg-gradient-to-r from-slate-800/50 to-transparent p-4 border-b border-slate-700/30 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full overflow-hidden border border-slate-700/30 flex items-center justify-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* Close Button */}
                  <motion.button
                    className="w-8 h-8 bg-slate-900/80 hover:bg-slate-900 rounded-full flex items-center justify-center border border-slate-700/50 ml-2"
              ...
              <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <div className="bg-slate-800/40 rounded-lg p-3 border border-slate-700/30">
                    ...
                    <div className="text-sm font-mono font-medium mt-1 text-white">
                      {selectedServer.ip}
                    </div>
                  </div>
                ...
                <div className="bg-slate-800/40 rounded-lg p-3 border border-slate-700/30">
                  ...
                  <div className="font-mono text-xs space-y-1 max-h-24 overflow-y-auto">
                    ...
                    <div className="text-slate-400">[15:40:05] Connection from {selectedServer.ip}</div>
                  </div>
                </div>
              </div>
            </motion.div>
